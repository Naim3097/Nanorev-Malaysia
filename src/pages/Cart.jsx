...
import { FREE_DELIVERY_THRESHOLD, DELIVERY_FEE } from '../utils/pricing'
...
export default function Cart() {
  ...
  useSeo({ title: 'Your Cart | NanoRev Malaysia', robots: 'noindex, nofollow' }, [])
  ...
  return (
    <div className="wrap page">
      <Link to="/shop" className="breadcrumb" style={{ display: 'inline-flex' }}>
